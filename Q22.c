...
int main(){
  ...
  int x, y, z;
  int i = 0;
  scanf("%d %d", &a, &b); // a = 10 e b = 1. a = 1010 e b = 0001
  x = a; y = b; z = a + b;
  while (a) { // a é dividido por 2 a cada iteração, while terá 4 iterações (pois a foi inicializado como 10)

  x = x | b;  // OU bit a bit. se pelo menos um deles tiver valor 1 retornará 1 naquela posição
